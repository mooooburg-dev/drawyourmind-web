<template>
  <div>
    <div class="work-item-img">
      <img src="/static/img/works/dior_0.jpg" />
    </div>
    <div class="work-item mt-4">
      ...
      <div class="img-container text-center mt-5">
        <ul>
          <li>
            <iframe width="840" height="473" src="https://www.youtube.com/embed/BSNH6ISMebA" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
          </li>
