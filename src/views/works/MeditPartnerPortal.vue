  ...
  <div class="work-item-container">
    ...
    <div class="work-item mt-5">
      ...
      <div class="mt-5">
        <h3>archive link</h3>
        <ul>
          <li><a href="https://https://github.com/mooooburg-dev/medit-partner-portal/issues?q=" target="_blank">github 프로젝트 이슈 노트</a></li>
      ...
      <div class="img-container text-center mt-5">
        <ul>
          ...
          <li>
            <p class="text-left">
              주요 기능은 제품 구매기능으로써 MPP를 통해 파트너가 제품을 구매하는 시점부터 주문 요청 및 확정, 출고 및 생산 단계를 거쳐 최종 제품발송 상태까지 파트너는 세부 주문 프로세스를 조회 및 확인할 수 있다. 또한 파트너가 현재까지 주문한 전체 히스토리 목록을 확인할 수 있는 파트너 주문 목록화면과 메디트 담당자가 조회할 수 있는 전체 주문 목록화면을 가지고 있으며 주문상세 페이지에서는 주문 사항의 세부 내용 조회가 가능하다.
            </p>
          </li>
