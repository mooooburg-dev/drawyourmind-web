  ...
  <div class="profile-menu-continer">
    <div class="profile mt-5 ml-5">
      ...
      <div class="profile-text-2 mt-4">
        ...
        <br />
        <br />
        <span><a href="http://github.com/mooooburg-dev" target="_blank">@Github</a></span>
        <br />
        <span><a href="https://twitter.com/jeongmu" target="_blank">@Twitter</a></span>
        <br />
        <span><a href="https://www.linkedin.com/in/jeongmupark" target="_blank">@Linkedin</a></span>
        <br />
      </div>
      <div class="mt-4">
        <ul class="logos">
